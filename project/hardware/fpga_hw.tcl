...
# parameters
# 
add_parameter total_bytes INTEGER 1536
set_parameter_property total_bytes DEFAULT_VALUE 1536
set_parameter_property total_bytes DISPLAY_NAME total_bytes
set_parameter_property total_bytes TYPE INTEGER
set_parameter_property total_bytes UNITS None
set_parameter_property total_bytes ALLOWED_RANGES -2147483648:2147483647
set_parameter_property total_bytes HDL_PARAMETER true
...
set_interface_property sdram associatedClock clock143
...
add_interface_port sdram mem_dq dq Bidir 16
add_interface_port sdram mem_a a Output 13
add_interface_port sdram mem_ba ba Output 2
add_interface_port sdram mem_cke cke Output 1
add_interface_port sdram mem_ldqm ldqm Output 1
add_interface_port sdram mem_udqm udqm Output 1
add_interface_port sdram mem_we_n we_n Output 1
add_interface_port sdram mem_cas_n cas_n Output 1
add_interface_port sdram mem_ras_n ras_n Output 1
add_interface_port sdram mem_cs_n cs_n Output 1
...
# 
# connection point clock143
# 
add_interface clock143 clock end
set_interface_property clock143 clockRate 0
set_interface_property clock143 ENABLED true
set_interface_property clock143 EXPORT_OF ""
set_interface_property clock143 PORT_NAME_MAP ""
set_interface_property clock143 CMSIS_SVD_VARIABLES ""
set_interface_property clock143 SVD_ADDRESS_GROUP ""

add_interface_port clock143 clk143 clk Input 1
