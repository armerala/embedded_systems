...
/* TODO: 0x0079, 0x0006 for VID/PID of joystick...do that?

  /* Look at each device, remembering the gamepad */
  ...
  for (d = 0 ; d < num_devs ; d++) {
	...
	fprintf(stderr, "device: %d\nclass: %d\nsubclass: %d\nprotocol: %d\nvendorID: %d\nmanufacturer: %d\nserial: %d\n", desc, 
		desc.bDeviceClass, desc.bDeviceSubClass, desc.bDeviceProtocol, desc.idVendor, desc.iManufacturer, desc.iSerialNumber);
